...
import com.conexaoauthlib.feign.scope.ScopeClient;
import org.springframework.cloud.openfeign.FeignClientBuilder;
import org.springframework.context.ApplicationContext;

/**
 * Factory para criação de instâncias de ScopeClient.
 *
 * <p>Esta classe utiliza o Spring Cloud OpenFeign para criar
 * instâncias dinâmicas de ScopeClient com todas as configurações
 * de resiliência e interceptores aplicadas.</p>
 *
 * <h3>Exemplo de uso:</h3>
 * <pre>{@code
 * // A factory é automaticamente inicializada pelo Spring
 * // Use ScopeClient para operações fluentes
 *
 ...
 * ScopeClientFactory.setApplicationContext(applicationContext);
 *
 * // Ou crie o cliente diretamente
 * ScopeClient client = ScopeClientFactory.createScopeClient();
 * }</pre>
 *
 * @author ConexãoAuthLib Team
 * @version 1.0.0
 * @see ScopeClient
 * @see com.conexaoauthlib.feign.scope.ScopeClient
 */
public final class ScopeClientFactory {
    ...
    public static void setApplicationContext(ApplicationContext context) {
        ScopeClientFactory.applicationContext = context;
    }

    /**
     * Cria uma nova instância de ScopeClient.
     *
     ...
     * </ul>
     *
     * @return ScopeClient configurado e pronto para uso
     * @throws IllegalStateException se o ApplicationContext não estiver configurado
     */
    public static ScopeClient createScopeClient() {
        ...
        return builder.forType(ScopeClient.class, "scope").build();
    }
}
