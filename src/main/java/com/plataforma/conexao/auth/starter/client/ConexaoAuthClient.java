 ...
 *
 * <p>
 * Este cliente fornece métodos para interagir com as principais APIs do
 * Auth Server, incluindo registro de usuários, busca de usuário e obtenção
 * de tokens via Client Credentials Flow.
 *
 * <p>
 * Utiliza OpenFeign para comunicação HTTP declarativa, com serialização
...
public interface ConexaoAuthClient {
     ...
     *
     * <p>
     * Cria um novo usuário com as informações fornecidas. O usuário será
     ...
     *
     * <p>
     * Endpoint: GET /api/v1/usuarios/cpf/{cpf}
     *
     * <p>
     * Retorna as informações do usuário correspondente ao CPF fornecido.
     ...
     *
     * <p>
     * Endpoint: GET /api/v1/usuarios/username/{username}
     *
     * <p>
     * Retorna as informações do usuário correspondente ao username (e-mail)
     * fornecido.
     * A busca é case-insensitive. Caso o usuário não seja encontrado, o Error
     * Decoder
     * lançará uma
     * {@link com.plataforma.conexao.auth.starter.exception.ResourceNotFoundException}.
     *
